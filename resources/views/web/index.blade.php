                ...
                <div class="col-md-4">
                    <div class="service left-icon probootstrap-animate">
                        ...
                        <div class="text">
                            ...
                            <p>At ExceedBuy.com we have always set out to be the kind of company that we would want to
                                deal with if we were making an online purchase. Consequently, we take security and
                                customer service very seriously and appreciate the trust placed in us by all of our
                                customers when making a purchase. </p>
                ...
                <div class="col-md-4">
                    <div class="service left-icon probootstrap-animate">
                        ...
                        <div class="text">
                            ...
                            <p>All our products are carefully selected and of the highest quality and checked before
                                dispatch. We aim to stock the highest quality brands of baby products! </p>
                            <!--<p><a href="single-page.html">Learn more</a></p>-->
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="service left-icon probootstrap-animate">
                        ...
                        <div class="text">
                            ...
                            <p>The ExceedBuy store has one main goal in mind. We aim to offer quality, unique and
                                affordable children's products to parents, grandparents, family and friends who will be
                                delighted to purchase (or receive as a gift) one of our products. </p>
                            <!--<p><a href="single-page.html">Learn more</a></p>-->
                        </div>
                    </div>
                </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel"
                                ...
                                <div class="panel-body">
                                    <p>We established ExceedBuy, to offer babies aged 3-36 months PREMIUM QUALITY
                                        products, in addictive TRENDY DESIGNS that will make your little treasure
                                        shine!</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-12 probootstrap-animate" data-animate-effect="fadeIn">
                    <figure>
                        <div class="probootstrap-video">
                            <a href="https://www.youtube.com/watch?v=YzKvTFdkatw"
